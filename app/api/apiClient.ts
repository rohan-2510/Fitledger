...
const apiClient = {
  ...
  setAuthToken: async (token: string) => { /* No-op or log warning */ console.warn('setAuthToken is deprecated with Firebase Auth'); },
  setRefreshToken: async (token: string) => { /* No-op or log warning */ console.warn('setRefreshToken is deprecated with Firebase Auth'); },
  clearTokens: async () => {
    await removeSecureItem('authToken'); // Clear any legacy tokens
    await removeSecureItem('refreshToken'); // Clear any legacy tokens
  },
  getAuthToken: async () => { /* No-op or log warning */ console.warn('getAuthToken is deprecated with Firebase Auth'); return null; },
  getRefreshToken: async () => { /* No-op or log warning */ console.warn('getRefreshToken is deprecated with Firebase Auth'); return null; },
